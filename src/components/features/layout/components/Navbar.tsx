    ...
    >
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8">
        <a href="#home" className="group flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-400 to-violet-500 font-display text-sm font-bold text-ink-950 shadow-[0_0_20px_rgba(34,211,238,0.35)] transition-transform group-hover:scale-105">
            AR
          </span>
          <span className="hidden font-display text-sm font-semibold tracking-wide text-white sm:block">
            Ahsan<span className="text-cyan-400">.</span>Rakib
          </span>
        </a>
        ...
        <div className="flex items-center gap-3">
          <a
            href="#contact"
            className="btn-sheen hidden rounded-full bg-gradient-to-r from-cyan-500 to-violet-500 px-5 py-2 text-sm font-semibold text-white transition-all hover:shadow-[0_0_24px_rgba(34,211,238,0.5)] md:inline-flex"
          >
            Hire Me
          </a>
          <button
