...
export function ProjectCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className="glass spotlight group flex h-full flex-col overflow-hidden rounded-3xl transition-all duration-300 hover:-translate-y-1.5 hover:border-cyan-400/30 hover:shadow-[0_20px_60px_-20px_rgba(34,211,238,0.25)]"
    >
      <div
        className={cn(
          "relative flex h-44 items-center justify-center overflow-hidden bg-gradient-to-br p-6",
          project.gradient,
        )}
      >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <p className="mt-2 min-h-[3.25rem] flex-1 text-sm leading-relaxed text-slate-400 line-clamp-2">
          {project.tagline}
        </p>
